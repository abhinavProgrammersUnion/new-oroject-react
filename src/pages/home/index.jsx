...
function Home() {
  ...
  return (
    <>
      ...
      <PostCarousel news={news} className="fifth_bg" />

      <PostGallery news={news} className="fifth_bg" />
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8">
              <div className="row">
                <div className="col-12">
                  <div className="heading">
                    <h2 className="widget-title">Science News</h2>
                  </div>
                </div>
              </div>
              {/*CAROUSEL START*/}
              ...
              {/*CAROUSEL END*/}
              <SportsNews />
              <div className="banner_area mt50 mb60 xs-mt60">mos
                <Link to="/">
